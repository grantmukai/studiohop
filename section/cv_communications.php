		...
		<div class="row">
			...
			<div class="col-md-6 col-md-offset-3 wow fadeIn">
				...
				if (preg_match('/^en-US/', $cv_lang)) {
					echo "<a href='cv_files/{$cv_lang}/Mukai_comCV_".str_replace('-','',$cv_lang)."_".date_format($prFileDate, 'mdy').".pdf' class='btn btn-default btn-custom-2'><i class='fa fa-cloud-download icon-before'></i> {$lang['telecharger_comcv']} ({$lang['prfile_size']}{$prFileByte})</a>";
						} else {
					echo "<a href='cv_files/{$cv_lang}/Mukai_comCV_".str_replace('-','',$cv_lang)."_".date_format($prFileDate, 'dmy').".pdf' class='btn btn-default btn-custom-2'><i class='fa fa-cloud-download icon-before'></i> {$lang['telecharger_comcv']} ({$lang['prfile_size']}{$prFileByte})</a>";
						} 
				?>
			</div>
